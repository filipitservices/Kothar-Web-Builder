    ...
    <template v-else-if="isAuthenticated">
      ...
      <Transition name="dropdown">
        <div v-if="isOpen" class="dropdown">
          ...
          <hr />
          <NuxtLink :to="PATH_GALLERY" class="item" @click="isOpen = false">
            <svg viewBox="0 0 20 20" fill="currentColor"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg>
            Gallery
          </NuxtLink>
          <NuxtLink :to="PATH_SITES" class="item" @click="isOpen = false">
          ...
          <NuxtLink :to="PATH_REPORT_ISSUE" class="item" @click="isOpen = false">
...
import { PATH_GALLERY, PATH_REPORT_ISSUE, PATH_SITES } from '~/constants/routes';
